...
{
    public class RebindActionUIDEPRECATED : MonoBehaviour
    {
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<RebindActionUIDEPRECATED, string, string, string> { }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<RebindActionUIDEPRECATED, RebindOperation> { }
